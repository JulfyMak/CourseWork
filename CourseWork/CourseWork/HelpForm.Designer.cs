namespace CourseWork
{
	partial class HelpForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label5.Size = new System.Drawing.Size(465, 19);
			this.label5.TabIndex = 9;
			this.label5.Text = "\"Продолжить\" - Запустить генератор с текущего значения.";
			// 
			// label4
			// 
			...
			this.label4.Size = new System.Drawing.Size(595, 19);
			this.label4.TabIndex = 8;
			this.label4.Text = "\"Пауза\" - Приостановить генератор для просмотра промежуточных данных.";
			// 
			// label2
			// 
			...
			this.label2.Text = "\"Старт\" - Начать работу генератора.";
			// 
			// label1
			// 
			...
			this.label1.Text = "Кнопки управления генератором:";
			// 
			// label14
			// 
			...
			this.label14.Size = new System.Drawing.Size(424, 19);
			this.label14.TabIndex = 18;
			this.label14.Text = "\"Lamda\" - коэфициент входящий в формулу функции.";
			// 
			// label7
			// 
			...
			this.label7.Size = new System.Drawing.Size(584, 19);
			this.label7.TabIndex = 15;
			this.label7.Text = "\"Кол-во чисел\" - То, сколько будет сгенерировано чисел [1 .. 100 000 000].";
			// 
			// label6
			// 
			...
			this.label6.Text = "Параметры генератора:";
			// 
			// label12
			// 
			...
			this.label12.Size = new System.Drawing.Size(453, 19);
			this.label12.TabIndex = 21;
			this.label12.Text = "\"Открыть\" - Восстановить прогресс с выбранного файла.";
			// 
			// label11
			// 
			...
			this.label11.Size = new System.Drawing.Size(527, 19);
			this.label11.TabIndex = 20;
			this.label11.Text = "\"Сохранить как\" - Сохранить текущий прогресс генератора в файл.";
			// 
			// label10
			// 
			...
			this.label10.Text = "Работа с файлами:";
			// 
			// label23
			// 
			this.label23.AutoSize = true;
			this.label23.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.label23.Location = new System.Drawing.Point(13, 247);
			this.label23.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.label23.Name = "label23";
			this.label23.Size = new System.Drawing.Size(797, 19);
			this.label23.TabIndex = 23;
			this.label23.Text = "Цифры с плавающей точкой (такие как 0,1) могут быть записаны как через \".\" так и " +
    "через \",\". ";
			// 
			// label22
			// 
			...
			this.label22.Location = new System.Drawing.Point(741, 79);
			this.label22.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.label22.Name = "label22";
			this.label22.Size = new System.Drawing.Size(253, 19);
			this.label22.TabIndex = 29;
			this.label22.Text = "с расспределением Пуассона";
			// 
			// label21
			// 
			this.label21.AutoSize = true;
			this.label21.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.label21.Location = new System.Drawing.Point(741, 60);
			this.label21.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.label21.Name = "label21";
			this.label21.Size = new System.Drawing.Size(243, 19);
			this.label21.TabIndex = 28;
			this.label21.Text = "Генератор случайных чисел";
			// 
			// label20
			// 
			this.label20.AutoSize = true;
			this.label20.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.label20.Location = new System.Drawing.Point(741, 40);
			...
			this.label17.Location = new System.Drawing.Point(741, 9);
			this.label17.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.label17.Name = "label17";
			this.label17.Size = new System.Drawing.Size(148, 19);
			this.label17.TabIndex = 26;
			this.label17.Text = "Курсовая работа";
			// 
			// label16
			// 
			this.label16.AutoSize = true;
			this.label16.Font = new System.Drawing.Font("Arial", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.label16.Location = new System.Drawing.Point(741, 132);
			this.label16.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
			this.label16.Name = "label16";
			this.label16.Size = new System.Drawing.Size(150, 19);
			this.label16.TabIndex = 25;
			this.label16.Text = "Кравченко Елена";
			// 
			// label15
			// 
			...
			this.label15.Location = new System.Drawing.Point(741, 110);
			...
			this.ClientSize = new System.Drawing.Size(1062, 279);
